...
use crate::olm::{messages::EncodedOlmMessage, shared_secret::Shared3DHSecret};
...
impl DoubleRatchet {
    pub fn encrypt(&mut self, plaintext: &str) -> EncodedOlmMessage {
...
impl ActiveDoubleRatchet {
    ...
    fn encrypt(&mut self, plaintext: &[u8]) -> EncodedOlmMessage {
